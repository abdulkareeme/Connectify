    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_tries', models.IntegerField(blank=True, default=3)),
                ...
                ('resend_tries', models.IntegerField(blank=True, default=3)),
                ('next_confirmation_code_sent', models.DateTimeField(blank=True, null=True)),
                ('forget_confirmation_tries', models.IntegerField(blank=True, default=3)),
                ('forget_next_confirm_try', models.DateTimeField(blank=True, null=True)),
                ('forget_password_code', models.CharField(blank=True, max_length=6, null=True)),
